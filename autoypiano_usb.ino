...
void loop() {
  ...
  do {
    ...
    if (usbrx.header != 0) {
      ...
      sole_on[24] =1;
      sole_sum = sole_sum + 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 77) or (usbrx.byte1 == 144 and usbrx.byte2 == 77 and usbrx.byte3 ==0) and sole_on[0] ==1) { //USB-MIDIでNoteOffの時
      mcp1.digitalWrite(0, LOW); 
      sole_on[0] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 78) or (usbrx.byte1 == 144 and usbrx.byte2 == 78 and usbrx.byte3 ==0) and sole_on[1] ==1) {
      mcp1.digitalWrite(1, LOW); 
      sole_on[1] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 79) or (usbrx.byte1 == 144 and usbrx.byte2 == 79 and usbrx.byte3 ==0) and sole_on[2] ==1) {
      mcp1.digitalWrite(2, LOW); 
      sole_on[2] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 80) or (usbrx.byte1 == 144 and usbrx.byte2 == 80 and usbrx.byte3 ==0) and sole_on[3] ==1) {
      mcp1.digitalWrite(3, LOW);
      sole_on[3] =0;
      sole_sum = sole_sum - 1; 
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 81) or (usbrx.byte1 == 144 and usbrx.byte2 == 81 and usbrx.byte3 ==0) and sole_on[4] ==1) {
      mcp1.digitalWrite(4, LOW);
      sole_on[4] =0;
      sole_sum = sole_sum - 1; 
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 82) or (usbrx.byte1 == 144 and usbrx.byte2 == 82 and usbrx.byte3 ==0) and sole_on[5] ==1) {
      mcp1.digitalWrite(5, LOW); 
      sole_on[5] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 83) or (usbrx.byte1 == 144 and usbrx.byte2 == 83 and usbrx.byte3 ==0) and sole_on[6] ==1) {
      mcp1.digitalWrite(6, LOW); 
      sole_on[6] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 84) or (usbrx.byte1 == 144 and usbrx.byte2 == 84 and usbrx.byte3 ==0) and sole_on[7] ==1) {
      mcp1.digitalWrite(7, LOW); 
      sole_on[7] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 85) or (usbrx.byte1 == 144 and usbrx.byte2 == 85 and usbrx.byte3 ==0) and sole_on[8] ==1) {
      mcp1.digitalWrite(8, LOW); 
      sole_on[8] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 86) or (usbrx.byte1 == 144 and usbrx.byte2 == 86 and usbrx.byte3 ==0) and sole_on[9] ==1) {
      mcp1.digitalWrite(9, LOW); 
      sole_on[9] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 87) or (usbrx.byte1 == 144 and usbrx.byte2 == 87 and usbrx.byte3 ==0) and sole_on[10] ==1) {
      mcp1.digitalWrite(10, LOW); 
      sole_on[10] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 88) or (usbrx.byte1 == 144 and usbrx.byte2 == 88 and usbrx.byte3 ==0) and sole_on[11] ==1) {
      mcp1.digitalWrite(11, LOW); 
      sole_on[11] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 89) or (usbrx.byte1 == 144 and usbrx.byte2 == 89 and usbrx.byte3 ==0) and sole_on[12] ==1) {
      mcp1.digitalWrite(12, LOW); 
      sole_on[12] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 90) or (usbrx.byte1 == 144 and usbrx.byte2 == 90 and usbrx.byte3 ==0) and sole_on[13] ==1) {
      mcp1.digitalWrite(13, LOW); 
      sole_on[13] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 91) or (usbrx.byte1 == 144 and usbrx.byte2 == 91 and usbrx.byte3 ==0) and sole_on[14] ==1) {
      mcp1.digitalWrite(14, LOW); 
      sole_on[14] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 92) or (usbrx.byte1 == 144 and usbrx.byte2 == 92 and usbrx.byte3 ==0) and sole_on[15] ==1) {
      mcp1.digitalWrite(15, LOW); 
      sole_on[15] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 93) or (usbrx.byte1 == 144 and usbrx.byte2 == 93 and usbrx.byte3 ==0) and sole_on[16] ==1) {
      mcp2.digitalWrite(0, LOW); 
      sole_on[16] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 94) or (usbrx.byte1 == 144 and usbrx.byte2 == 94 and usbrx.byte3 ==0) and sole_on[17] ==1) {
      mcp2.digitalWrite(1, LOW); 
      sole_on[17] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 95) or (usbrx.byte1 == 144 and usbrx.byte2 == 95 and usbrx.byte3 ==0) and sole_on[18] ==1) {
      mcp2.digitalWrite(2, LOW); 
      sole_on[18] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 96) or (usbrx.byte1 == 144 and usbrx.byte2 == 96 and usbrx.byte3 ==0) and sole_on[19] ==1) {
      mcp2.digitalWrite(3, LOW); 
      sole_on[19] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 97) or (usbrx.byte1 == 144 and usbrx.byte2 == 97 and usbrx.byte3 ==0) and sole_on[20] ==1) {
      mcp2.digitalWrite(4, LOW); 
      sole_on[20] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 98) or (usbrx.byte1 == 144 and usbrx.byte2 == 98 and usbrx.byte3 ==0) and sole_on[21] ==1) {
      mcp2.digitalWrite(5, LOW); 
      sole_on[21] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 99) or (usbrx.byte1 == 144 and usbrx.byte2 == 99 and usbrx.byte3 ==0) and sole_on[22] ==1) {
      mcp2.digitalWrite(6, LOW); 
      sole_on[22] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 100) or (usbrx.byte1 == 144 and usbrx.byte2 == 100 and usbrx.byte3 ==0) and sole_on[23] ==1) {
      mcp2.digitalWrite(7, LOW); 
      sole_on[23] =0;
      sole_sum = sole_sum - 1;
    } if (usbrx.header != 0 and (usbrx.byte1 == 128 and usbrx.byte2 == 101)  or (usbrx.byte1 == 144 and usbrx.byte2 == 101 and usbrx.byte3 ==0)and sole_on[24] ==1) {
